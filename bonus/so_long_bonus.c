...
/*   Updated: 2024/03/14 15:51:26 by moer-ret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long_bonus.h"

void	to_fix_nor(t_game *game, int i, int j, int x)
{
	static int h;
...
void	so_long(t_game *game)
{
	...
	mlx_loop_hook(game->mlx_in, &animation, game);
